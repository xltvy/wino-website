    ...
    <div className="App">
      <div className="desktop-layout" style={{backgroundImage: `url(${desktopSource})`}} >
          <div className="desktop-film-container">
            <video ref={video1Ref} className='desktop-film' poster={DesktopBackground} autoPlay={false} loop={false} muted={true} playsinline="true" disablePictureInPicture="true" style={{ display: currentVideo === 1 ? 'block' : 'none' }}>
              <source src={Video1} type="video/mp4" />
            </video>
            <video ref={video2Ref} className='desktop-film' poster={DesktopEmptyBackground} autoPlay={false} loop={false} muted={true} playsinline="true" disablePictureInPicture="true" style={{ display: currentVideo === 2 ? 'block' : 'none' }}>
