...
import Logo from "../../images/client_logos/sundei-logo.png";

const SundeiContent = () => {
    return (
        <>
            <img src={Logo} alt="Sundei Logo" style={{ width: "60%", height: "auto", paddingTop: "8px" }} loading="lazy"/>
            <p>As Studio WINO we have designed a brand identity system and packaging for the Istanbul based textile brand SUNDËI.</p>
