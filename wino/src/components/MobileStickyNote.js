            ...
            <div className="sticky-note-lower">
                <div className="sticky-note-body">
                    ...
                    <p className='sticky-note-text'>
                        WINO is an award-winning creative studio inspired by human-centered outcomes. 
                        Here, visual communication strategies, campaigns, graphic design and industrial products are created by us, for all.
                    </p>
                </div>
            </div>
        </div>
